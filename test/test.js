describe('remote-input', function () {
  ...
  describe('after tree insertion', function () {
    ...
    it('loads content', async function () {
      ...
      await loadend
      assert.equal(
        results.querySelector('ol').getAttribute('data-src'),
        '/results?q=test'
      )
    })
    ...
    it('handles network error', async function () {
      ...
      changeValue(input, 'test')
      assert.ok(
        remoteInput.hasAttribute('loading'),
        'loading attribute should have been added'
      )
      ...
      assert.notOk(
        remoteInput.hasAttribute('loading'),
        'loading attribute should have been removed'
      )
    })
